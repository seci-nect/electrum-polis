...
;Variables
  ...
  !define PRODUCT_WEB_SITE "https://github.com/akhavr/electrum-polis"
...
;General
  ...
  ;Name and file
  Name "${PRODUCT_NAME}"
  OutFile "dist/electrum-polis-${PRODUCT_VERSION}-setup-${BUILD_ARCH}.exe"
...
Section
  ...
  CreateShortCut "$SMPROGRAMS\${PRODUCT_NAME}\${PRODUCT_NAME} Testnet.lnk" "$INSTDIR\electrum-polis-${PRODUCT_VERSION}.exe" "--testnet" "$INSTDIR\electrum-polis-${PRODUCT_VERSION}.exe" 0
...
Section "Uninstall"
  ...
  DeleteRegKey HKCU "Software\Classes\polis"

...
from electrum_seci_gui.kivy.nfc_scanner import NFCBase
...
class ScannerAndroid(NFCBase):
    ...
    def create_AAR(self):
        ...
        return NdefRecord.createApplicationRecord(
            JString("org.electrum_seci.electrum_seci_develop.kivy"))

    def create_TNF_EXTERNAL(self, data):
        '''Create our actual payload record.
        '''
        if BUILDVERSION >= 14:
            domain = "org.electrum_seci.electrum_seci_develop"
            stype = "externalType"
            ...
            extRecord = NdefRecord(
                ...
                "org.electrum_seci_electrum_seci.electrum_seci_develop:externalType",
                '',
                data)
        return extRecord
    ...
    def _nfc_enable_ndef_exchange(self, data):
        ...
        ndef_record = NdefRecord(
                ...
                'org.electrum_seci.electrum_seci_develop.kivy', '', data)

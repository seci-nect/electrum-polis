...
class ScannerAndroid(NFCBase):
    ...
    def create_AAR(self):
        ...
        '''
        return NdefRecord.createApplicationRecord(JString("org.polis.electrum.kivy"))

    def create_TNF_EXTERNAL(self, data):
        '''Create our actual payload record.
        '''
        if BUILDVERSION >= 14:
            domain = "org.polis.electrum"
            stype = "externalType"
            ...
            extRecord = NdefRecord(
                ...
                "org.polis.electrum:externalType",
                '',
                data)
        return extRecord

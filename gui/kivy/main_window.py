...
#Factory.register('InstallWizard', module='electrum_polis_gui.kivy.uix.dialogs.installwizard')
...
# the data
Cache.register('electrum_polis_widgets', timeout=0)
...
class ElectrumWindow(App):
    ...
    def _get_bu(self):
        return self.electrum_config.get('base_unit', 'POLIS')
    ...
    def on_qr(self, data):
        ...
        from electrum_polis.util import bh2u
        try:
    ...
    def scan_qr(self, on_complete):
        ...
        SimpleScannerActivity = autoclass("org.polis.electrum.qr.SimpleScannerActivity")
    ...
    def init_ui(self):
        ...
        #Cache.append('electrum_polis_widgets', 'AnimatedPopup', Factory.AnimatedPopup())
        #Cache.append('electrum_polis_widgets', 'QRCodeWidget', Factory.QRCodeWidget())

...
from electrum_polis.bitcoin import is_address, COIN, TYPE_ADDRESS
    ...
    def network_dialog(self):
        ...
        if out:
            ...
            if out.get('server') or out.get('proxy'):
                proxy = electrum_polis.network.deserialize_proxy(out.get('proxy')) if out.get('proxy') else proxy_config

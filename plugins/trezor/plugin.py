...
from electrum_seci.bitcoin import (bc_address_to_hash_160, xpub_from_pubkey,
...
from electrum_seci.transaction import deserialize, Transaction
from electrum_seci.keystore import Hardware_KeyStore, is_xpubkey, parse_xpubkey
...
class TrezorCompatiblePlugin(HW_PluginBase):
    ...
    def get_coin_name(self):
        return "Seci Testnet" if TESTNET else "Seci"

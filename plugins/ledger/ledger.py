...
from electrum_seci.bitcoin import (TYPE_ADDRESS, int_to_hex, var_int,
...
from electrum_seci.keystore import Hardware_KeyStore, parse_xpubkey
from electrum_seci.transaction import push_script, Transaction
from ..hw_wallet import HW_PluginBase
from electrum_seci.util import format_satoshis_plain, print_error, is_verbose
    ...
    def checkDevice(self):
        if not self.preflightDone:
            try:
                ...
                if (e.sw == 0x6d00):
                    raise BaseException("Device not in Seci mode")
                raise e
